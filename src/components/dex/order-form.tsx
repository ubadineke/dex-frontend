    ...
    return (
      <div className="trading-panel">
        ...
        <div className="text-center py-8">
          <div className="w-12 h-12 rounded-full bg-long/10 flex items-center justify-center mx-auto mb-4">
            <svg className="h-6 w-6 text-long" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <p className="font-medium text-long mb-2">Market Settled</p>
